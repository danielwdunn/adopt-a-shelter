...
class MainControllerTest < ActionController::TestCase
  ...
  test 'should return the home page' do
    ...
    assert_select 'title', 'Adopt-a-Shelter'
    assert_select 'p#tagline', 'Claim responsibility for a bus shelter in your town.'
  end
